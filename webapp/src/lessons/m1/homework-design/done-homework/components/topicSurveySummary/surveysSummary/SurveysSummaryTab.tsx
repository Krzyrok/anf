...
//    then we can use single type shape (domain) shared between SurveysSummaryTab and IndividualSurveysTab
...
//    type on FE between SurveysSummaryTab and IndividualSurveysTab
//
// or optimize that and do that on BE
interface SurveysSummaryTabProps {
  answeredSurveys: AnsweredSurvey[];
}

// renders:
// - TODO K:
export declare const SurveysSummaryTab: React.FC<SurveysSummaryTabProps>;
